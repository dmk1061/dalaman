...
- **Где проходит:** Охватывает полуострова [Датча](/dacha) и Бозбурун, внутренние районы провинции Мугла. Маршрут от [Мармариса](/marmaris) на запад — это как раз территория Карийской тропы.
