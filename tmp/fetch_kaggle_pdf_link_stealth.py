...
# Обход обнаружения автоматизации
chrome_options.add_argument("--disable-blink-features=AutomationControlled")
chrome_options.add_experimental_option("excludeSwitches", ["enable-automation"])
chrome_options.add_experimental_option('useAutomationExtension', False)
chrome_options.add_argument("user-agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36")

print("Initializing Chrome Driver in Stealth mode...")
...
try:
    ...
    with open("tmp/kaggle_stealth_page.html", "w", encoding="utf-8") as f:
        f.write(html)
    ...
    if not drive_id:
        # Попробуем найти ID просто по регулярному выражению в тексте HTML
    ...
    if drive_id:
        ...
        print("Could not find Google Drive PDF ID on the page.")
