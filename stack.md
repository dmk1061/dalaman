# Технологический стек проекта "Путеводитель: Дача — Каш"

Этот документ описывает технологический стек, который будет использоваться для разработки туристического портала.
...
- **Язык портала:** На данный момент основная версия разрабатывается на **русском языке**.
