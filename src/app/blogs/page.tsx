        ...
        <div className="flex flex-col min-h-screen bg-slate-50">
            ...
            <main className="flex-grow container mx-auto px-4 py-8 pb-20">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    <span className="text-cyan-600 font-black text-xs uppercase tracking-[0.3em] mb-2 block">БЛОГИ ПУТЕШЕСТВЕННИКОВ</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 max-w-6xl mx-auto">
                            ...
                            <article key={idx} className="group bg-white rounded-[3rem] overflow-hidden premium-shadow border border-slate-50 hover:-translate-y-1 transition-all duration-300">
                                <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                                    ...
                                    <div className="p-8 md:col-span-3 flex flex-col justify-between">
                                        ...
                                        >
                                            Читать далее <FaChevronRight size={10} />
                                        </Link>
                                    </div>
                                </div>
                            </article>
                    ...
                    <aside className="lg:col-span-4 space-y-8">
                        <div className="bg-white rounded-[2.5rem] p-8 premium-shadow border border-slate-50">
                            <h3 className="text-lg font-black text-slate-900 mb-6 uppercase italic border-b border-slate-100 pb-4">Популярные теги</h3>
                        ...
                        <div className="bg-gradient-to-br from-cyan-600 to-blue-700 rounded-[2.5rem] p-8 text-white premium-shadow relative overflow-hidden group">
                            <div className="relative z-10">
                                <h3 className="text-xl font-black mb-4 uppercase italic leading-tight">Хотите стать автором?</h3>
                                <p className="text-cyan-100 text-sm font-medium mb-6 leading-relaxed">Поделитесь своим опытом путешествия по побережью от Датчи до Каша на нашем портале!</p>
